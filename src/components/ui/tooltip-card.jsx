      ...
      <AnimatePresence>
        {isVisible && (
          <motion.div
            ...
            className="pointer-events-none absolute z-500 min-w-[15rem] overflow-hidden rounded-2xl border border-transparent shadow-sm ring-1 shadow-black/5 ring-black/5 bg-neutral-800 dark:shadow-white/10 dark:ring-white/5"
            style={{
              top: position.y,
              left: position.x,
            }}>
            <div
              ref={contentRef}
              className="p-2 text-sm text-neutral-600 md:p-3 dark:text-neutral-400">
              {content}
            </div>
          </motion.div>
        )}
